...
The application will start, and you can access it at [https://localhost:7151](https://localhost:7151) (by default). Swagger UI will be available at [https://localhost:7151/swagger](https://localhost:7151/swagger).
